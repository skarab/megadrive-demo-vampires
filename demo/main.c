...
int main()
{
	...
	VDP_setPaletteColors(0, test.palette->data, 16);

    	while(1)
    	{
		memcpy(smeFRAMEBUFFER, test.image, smeFRAMEBUFFER_Width*smeFRAMEBUFFER_Height*2);
...
void SCENE_Barrel_Create()
{
    ...
    //SCENE_Barrel_BitmapWidth = barrel.Width;
    //SCENE_Barrel_BitmapHeight = barrel.Height;
...
void SCENE_Barrel()
{
    ...
    void initTable()
    {
        ...
        //VDP_setPaletteColors(0, barrel.Palette, 16);
    ...
    //VDP_loadBMPTileData((u32*)barrel.Data, 1, w/8, h/8, w/8);
